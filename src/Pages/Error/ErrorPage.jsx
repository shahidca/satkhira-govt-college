...
function ErrorPage() {
  return (
    <div>
      <Helmet><title>Satkhira Govt College | Error</title></Helmet>
  ...
  <div class="text-center">
    ...
    <p class="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Sorry, we couldn’t find the page you’re looking for Satkhira Govt College.</p>
