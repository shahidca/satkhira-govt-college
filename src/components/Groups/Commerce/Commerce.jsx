    ...
    <div className="w-full min-h-screen bg-white">
      ...
      <section className="py-20 container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
          Why Study <span className="text-green-600">Commerce?</span>
        </h2>
          ...
          {[1,2,3].map((t, i) => (
            ...
            >
              ...
              <p className="text-gray-700 text-lg italic mb-4">
                "Studying Commerce opened my mind and changed the way I understand people and society. Absolutely transformative!"
              </p>
              <h4 className="text-gray-900 font-bold text-xl">Ayesha Rahman</h4>
              <p className="text-gray-600">Student, Commerce</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 text-center">
        ...
        >
          Ready to Join the Commerce Department?
        </motion.h2>
